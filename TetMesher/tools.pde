...
color black = #000000, white = #FFFFFF,  // set more colors using Menu >  Tools > Color Selector
  ...
  grey = #818181, orange = #FFA600, brown = #B46005, metal = #B5CCDE, lime = #A4FA83, pink = #FCC4FA, 
  dgreen = #057103, lightWood = #F5DEA6, darkWood = #D8BE7A;
